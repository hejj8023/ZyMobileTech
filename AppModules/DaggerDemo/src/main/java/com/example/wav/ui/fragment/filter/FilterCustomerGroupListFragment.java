...
public class FilterCustomerGroupListFragment extends
        BaseDaggerSupportListFragment<FilterCustomerGroupListPresenter,
                FilterCustomerGroupListContract
                .IFilterCustomerGroupListView, AccountGroupInfo> implements
        FilterCustomerGroupListContract
    ...
    private class GroupListAdapter extends BaseListAdapter<AccountGroupInfo> {
        ...
        @Override
        protected void bindDatas(QuickViewHolder holder, AccountGroupInfo bean, int itemViewType,
                                 int position) {
