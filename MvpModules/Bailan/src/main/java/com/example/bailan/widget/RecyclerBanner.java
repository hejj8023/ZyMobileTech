...
public class RecyclerBanner extends FrameLayout {
    ...
    private class ReyclerAdapter extends RecyclerView.Adapter {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            RecyclerView.LayoutParams l = new RecyclerView.LayoutParams(ViewGroup.LayoutParams
    ...
    class PagerSnapHelper extends LinearSnapHelper {
        ...
        public int findTargetSnapPosition(RecyclerView.LayoutManager layoutManager, int
            ...
            if (targetPos != RecyclerView.NO_POSITION && currentView != null) {
                ...
                targetPos = targetPos < currentPostion ? currentPostion - 1 : (targetPos >
                        currentPostion ? currentPostion + 1 : currentPostion);
            }
            return targetPos;
        }
    }
