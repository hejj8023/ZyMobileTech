            ...
            for (int i = 0; i < track.getDecodingTimeEntries().size(); i++) {
                ...
                for (int j = 0; j < entry.getCount(); j++) {
                    ...
                    if (currentTime <= endTime) {
                        // current sample is after the new start time and still before the new
                        // endtime
...
//            break;
    ...
    public static void appendVideo(Context context, String saveVideoPath, String[] videos) throws
            IOException {
...
//    }
    ...
    public static String[] getVideoWidthHeight(String path) {
        ...
        String video_width = retriever.extractMetadata(MediaMetadataRetriever
                .METADATA_KEY_VIDEO_WIDTH);
        String video_height = retriever.extractMetadata(MediaMetadataRetriever
