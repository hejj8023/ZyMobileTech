...
//            cameraFacing = CameraUtils.getCameraFacing(context, Camera.CameraInfo
// .CAMERA_FACING_BACK);
        }
...
//            cameraFlash = CameraUtils.getCameraFlash(context);
    ...
    private void initCameraParameters(int cameraId, int width, int height) {
        ...
        if (!isEmpty(pictureSizes) && !isEmpty(previewSizes)) {
            ...
            LogUtils.i("TextureSize " + width + " " + height + " optimalSize pic " +
                    optimalPicSize.width + " " + optimalPicSize.height + " pre " + optimalPreSize
                    .width + " " + optimalPreSize.height);
