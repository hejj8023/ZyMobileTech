...
# remusic(仿网易云音乐 安卓版，netease android，音乐播放器 在线 下载) <需要练习的项目>
https://github.com/aa112901/remusic

# 基于retorfit2，Rxjva2，Okhttp3，Glide，Dagger2,GreenDAO等框架采用MVP架构的仿应用商店App<计划实施中...>
...
# 医学考试APP 模拟考试 随机抽题 错题练习 视频播放 题库导入 <需要练习的项目>
...
##影视天地（Android 客户端） -> <需要练习的项目> 学习中.
https://github.com/123lxw123/VideoWorld_Android

##小简报 (知乎日报Android客户端) -> <需要练习的项目> 学习中.
...
## 我的音乐-Musicoco <需要练习的项目>
https://github.com/DuanJiaNing/Musicoco

## 小秋魔盒（QBox） <需要练习的项目>
https://github.com/OCNYang/QBox

## 【游戏资讯】一款游戏资讯应用 <需要练习的项目>
https://github.com/xiaohaibin/DMGameApp

## BLE-RSSI-Sample
https://github.com/452MJ/BLE-RSSI-Sample



# 视频监控
## 使用Android手机做监控
https://blog.csdn.net/huplion/article/details/71597910
https://github.com/zhangpengpengpeng/monitor

## android移动监控，一个演示用的Demo，android手机当作摄像头，拍视频实时在电脑上看到。
https://github.com/sencloudx/mobile-monitor