# 项目收集 #
- [模仿超级课程表，模拟登陆学校的正方教育系统](https://github.com/newbiechen1024/CourseScheduleDemo)
- [Android 网格分页布局](https://github.com/GcsSloop/pager-layoutmanager)
- [安卓学习笔记 ](https://github.com/GcsSloop/AndroidNote)
- [diycode android app](https://github.com/GcsSloop/diycode)
- [WanAndroidClient -> 学习中.x](https://github.com/wangzailfm/WanAndroidClient)
- [玩安卓客户端(Java版) -> 学习中.](https://github.com/kangdongpu/WanAndroid)
...
- [在Android上使用Tensorflow](https://github.com/dongchangzhang/NewFeelings)
...
- [一个物联网(IoT)开发的入门教程](https://github.com/nladuo/IoT-Firstep)
- [ 中国移动物联网开放平台 AndroidSDK](https://github.com/cm-heclouds/AndroidSDK)
- [基于xmpp的android客户端，实现与物联网节点的交互。](https://github.com/tiandawu/IotXmpp)
- [汽车-androidAPP-物联网-蓝牙](https://github.com/tangqianfeng/BlueToothProject)
- [基于物联网的智能厨房android客户端](https://github.com/Eccolala/BCCookIt)
- [智能家居 控制 物联网 摄像头 开关](https://github.com/luojie1024/HuanTaiSmartHome)
- [环泰智慧社区 智能家居 物联网](https://github.com/luojie1024/SmartCommunity)
...
[BLE-RSSI-Sample](https://github.com/452MJ/BLE-RSSI-Sample)



# 视频监控 #

[使用Android手机做监控](https://blog.csdn.net/huplion/article/details/71597910)
[android移动监控，一个演示用的Demo，android手机当作摄像头，拍视频实时在电脑上看到。](https://github.com/sencloudx/mobile-monitor)


[利用Jenkins实现Android自动打包发包](https://github.com/mabeijianxi/android-automation)


# 练习的项目 #
1. [影视天地（Android 客户端） -> <需要练习的项目> 学习中.](https://github.com/123lxw123/VideoWorld_Android)
1. [小简报 (知乎日报Android客户端) -> <需要练习的项目> 学习中.](https://github.com/123lxw123/DailyNews)
1. [高仿腾讯漫画的APP  <需要练习的项目>](https://github.com/zhhr1122/z_comic_new)
1. [我的音乐-Musicoco <需要练习的项目>](https://github.com/DuanJiaNing/Musicoco)
1. [小秋魔盒（QBox） <需要练习的项目>](https://github.com/OCNYang/QBox)
1. [【游戏资讯】一款游戏资讯应用 <需要练习的项目>](https://github.com/xiaohaibin/DMGameApp)
1. [WanAndroidClient(kotlin版) -> 学习中...](https://github.com/wangzailfm/WanAndroidClient)
1. [Xposed Remove 微博国际版(Weico) the start Ad](https://github.com/wangzailfm/XposedRemoveAd)
