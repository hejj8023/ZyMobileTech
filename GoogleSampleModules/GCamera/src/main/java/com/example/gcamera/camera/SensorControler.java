...
public class SensorControler implements IActivityLifiCycle, SensorEventListener, LogListener {
    private static SensorControler mInstance;
    private final SensorManager mSensorManager;
    private final Sensor mSensor;
    private int foucsing;
...
//                                Log.i(TAG,"mobile focusing");
    ...
    public void lockFocus() {
        isFocusing = true;
        foucsing--;
        LoggerUtils.loge(this, "lockFocus");
    }
    ...
    public void unlockFocus() {
        isFocusing = false;
        foucsing++;
        LoggerUtils.loge(this, "unlockFocus");
    }
